...
export const Navbar = () => {
    return (
        <div className="flex items-center mx-[100px] py-6">
            <Logo />
            ...
            <ul className="grid grid-cols-5 gap-x-[25px] mx-auto">
                <li className="text-white cursor-pointer">Home</li>
                <li className="cursor-pointer hover:border-b-2 hover:text-yellow-50 border-primary pb-2">About</li>
                <li className="cursor-pointer hover:border-b-2 hover:text-yellow-50 border-primary pb-2">Feature</li>
                <li className="cursor-pointer hover:border-b-2 hover:text-yellow-50 border-primary pb-2">Pricing</li>
                <li className="cursor-pointer hover:border-b-2 hover:text-yellow-50 border-primary pb-2">Blog</li>
            </ul>
